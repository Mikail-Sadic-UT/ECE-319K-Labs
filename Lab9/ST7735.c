...
// Outputs: none
void ST7735_OutCharCool(char ch, uint8_t size, uint16_t color)
{
...
{
  ST7735_OutCharCool(ch, 1, StTextColor);
}
...
// outputs: none
void ST7735_OutStringCool(char *ptr, uint8_t size, uint16_t color)
{
  while (*ptr)
  {
    ST7735_OutCharCool(*ptr, size, color);
    ptr = ptr + 1;
  }
}
...
{
  ST7735_OutStringCool(ptr, 1, StTextColor);
}
// ************** ST7735_SetTextColor ************************
