...
void TIMG12_IRQHandler(void){
  ...
  if((TIMG12->CPU_INT.IIDX) == 1){ // this will acknowledge
    ...
    //GPIOB->DOUTTGL31_0 = GREEN; // toggle PB27 (minimally intrusive debugging) WHY IS THIS REPEATED????
    Time++;
    Data = ADCin();  // sample 12-bit ADC0 channel 5, slidepot
...
int main(void){ // main5
  ...
  while(1){ // write this
    if(Flag){ // wait for semaphore
        ...
        //GPIOB->DOUTTGL31_0 = RED; // toggle red LED2 on Port B, PB26  WHY DO IT TWICE???
